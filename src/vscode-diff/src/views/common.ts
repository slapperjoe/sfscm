...
export function addButtonActiveStyleEvents (element: HTMLButtonElement | HTMLInputElement | undefined) {
...
export function setLabel (element: HTMLElement | undefined, title: string) {
...
export function disableContextMenu (element: HTMLElement | undefined) {
