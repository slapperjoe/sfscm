...
export class L13DiffActionsComponent extends L13Element<L13DiffActionsViewModel> {
	...
	public copyRight: HTMLButtonElement | undefined;
	
	@L13Query('#l13_select_deleted')
	public selectDeleted: HTMLButtonElement | undefined;
	
	@L13Query('#l13_select_modified')
	public selectModified: HTMLButtonElement | undefined;
	
	@L13Query('#l13_select_untracked')
	public selectUntracked: HTMLButtonElement | undefined;
	
	@L13Query('#l13_select_all')
	public selectAll: HTMLButtonElement | undefined;
	
	@L13Query('#l13_copy_left')
	public copyLeft: HTMLButtonElement | undefined;
