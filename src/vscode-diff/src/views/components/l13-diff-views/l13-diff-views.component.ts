...
export class L13DiffViewsComponent extends L13Element<L13DiffViewsViewModel> {
	...
	public unchanged: HTMLInputElement | undefined;
	
	@L13Query('#l13_show_deleted')
	public deleted: HTMLInputElement | undefined;
	
	@L13Query('#l13_show_modified')
	public modified: HTMLInputElement | undefined;
	
	@L13Query('#l13_show_untracked')
	public untracked: HTMLInputElement | undefined;
	
	@L13Query('#l13_show_ignored')
	public ignored: HTMLInputElement | undefined;
